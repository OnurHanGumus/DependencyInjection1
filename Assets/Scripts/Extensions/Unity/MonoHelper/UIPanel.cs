...
namespace Extensions.Unity.MonoHelper
{
    public class UIPanel : UIBase
    {
        ...
        protected List<UIButtonTMP> _uIButs = new List<UIButtonTMP>();

        [ShowIf("@_manualReference == true")][SerializeField]
        protected List<UITMP> _uITMPs = new List<UITMP>();

        [ShowIf("@_manualReference == true")][SerializeField]
        protected List<UIIMG> _uIIMGs = new List<UIIMG>();

        [ShowIf("@_manualReference == true")][SerializeField]
        private List<Image> _myOtherIMGs = new List<Image>();

        [ShowIf("@_manualReference == true")][SerializeField]
        private List<TextMeshProUGUI> _myOtherTMPs = new List<TextMeshProUGUI>();

        [ShowIf("@_manualReference == true")][SerializeField]
        private List<RawImage> _myOtherRawIMGs = new List<RawImage>();
